...
const CoursePage = ({ params }: { params: { courseId: string } }) => {
  ...
  const { data: course, isLoading } = useQuery(["course", params.courseId], {
    queryFn: async () => getCourse(params.courseId),
  });
    ...
    <div className="flex h-full bg-gray-50">
        ...
        {course ? (
          <>
            <div className="mb-8 bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-500 text-base">{course.subheading}</p>
            </div>
      ...
      <div className="w-1/4 bg-white py-6 shadow-lg">
        ...
        <div className="items-center flex justify-center w-full">
          <Link
            href={`/mytasks/${course?.quizzes[0].id}`}
